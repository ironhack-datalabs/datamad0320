...
#No, because they don't have the same shape ((2,3,5) x (5,2,3)).
...
#It works beacause they are the same shape now.
...
# "d" is the sum of the values of the itens of "a" with 1. 
...
#Yes, because e is equal to a*c and since c =1, therefore e = a.  
